...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Language as _Language, Story as _Story, StoryId as _StoryId, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addStory(arg0: string, arg1: Category, arg2: Language, arg3: ExternalBlob, arg4: string, arg5: string): Promise<StoryId> {
        if (this.processError) {
            try {
                const result = await this.actor.addStory(arg0, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg1), to_candid_Language_n10(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecipientEmail(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecipientEmail();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoriesByCategory(arg0: Category): Promise<Array<Story>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoriesByCategory(to_candid_Category_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoryById(arg0: StoryId): Promise<Story> {
        if (this.processError) {
            try {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        pdfBlob: await from_candid_ExternalBlob_n18(_uploadFile, _downloadFile, value.pdfBlob),
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "urdu" in value ? Language.urdu : value;
}
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "historical" in value ? Category.historical : "islamic" in value ? Category.islamic : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.historical ? {
        historical: null
    } : value == Category.islamic ? {
        islamic: null
    } : value;
}
