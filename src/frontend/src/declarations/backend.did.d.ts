...
export type Category = { 'historical' : null } |
  { 'islamic' : null };
...
export type Language = { 'urdu' : null };
...
export interface _SERVICE {
  ...
  'addStory' : ActorMethod<
    [string, Category, Language, ExternalBlob, string, string],
    StoryId
  >,
  ...
  'getRecipientEmail' : ActorMethod<[], string>,
  'getStoriesByCategory' : ActorMethod<[Category], Array<Story>>,
  'getStoryById' : ActorMethod<[StoryId], Story>,
